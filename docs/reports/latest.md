...
Generated **2026-08-15T11:56:08Z** · mainnet-beta · health score **100/100 (healthy)**
...
| Slot time (sampled) | 0.4126 s |
| Epoch progress | 19.69% |
| Active validators | 688 |
| Delinquent stake | 0.0128% |

## Economic pulse

| Metric | Current | 24h change |
|---|---:|---:|
| SOL price | 75.19 USD | -0.40% |
| DeFi TVL | 4.81B USD | — |
| Stablecoin supply | 15.35B USD | — |
| DEX volume | 1.61B USD | -17.00% |
| Protocol fees | 7.97M USD | -21.45% |
