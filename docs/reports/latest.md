...
Generated **2026-09-11T15:12:24Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 4.56K tx/s |
| Slot time (sampled) | 0.3189 s |
