...
Generated **2026-08-07T10:33:14Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 3.07K tx/s |
| Slot time (sampled) | 0.4203 s |
| Epoch progress | 36.05% |
