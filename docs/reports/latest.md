...
Generated **2026-08-15T11:33:27Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 3.16K tx/s |
| Slot time (sampled) | 0.4114 s |
| Epoch progress | 18.93% |
