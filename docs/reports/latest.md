...
Generated **2026-08-22T21:57:13Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 3.57K tx/s |
| Slot time (sampled) | 0.3694 s |
| Epoch progress | 86.76% |
