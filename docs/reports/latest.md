...
Generated **2026-08-16T11:33:23Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 2.82K tx/s |
| Slot time (sampled) | 0.4133 s |
| Epoch progress | 67.01% |
...
|---|---|---:|---:|
| WARNING | DEX volume | 1.17BUSD | -27.34% |
