...
Generated **2026-09-19T19:18:54Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 4.82K tx/s |
| Slot time (sampled) | 0.2680 s |
| Epoch progress | 19.41% |
...
|---|---|---:|---:|
| WARNING | SOL price | 110.97USD | +9.41% |
