...
Generated **2026-08-08T08:59:11Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 2.81K tx/s |
| Slot time (sampled) | 0.4201 s |
| Epoch progress | 80.34% |
