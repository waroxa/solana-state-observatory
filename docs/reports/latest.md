...
Generated **2026-08-16T14:00:45Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 3.21K tx/s |
| Slot time (sampled) | 0.4162 s |
| Epoch progress | 71.93% |
