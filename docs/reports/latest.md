...
Generated **2026-08-09T12:04:31Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 3.11K tx/s |
| Slot time (sampled) | 0.4220 s |
| Epoch progress | 33.79% |
...
|---|---:|---:|
| SOL price | 76.41 USD | 1.19% |
| DeFi TVL | 4.82B USD | — |
| Stablecoin supply | 15.61B USD | — |
| DEX volume | 1.49B USD | 9.69% |
| Protocol fees | 9.18M USD | 12.55% |
