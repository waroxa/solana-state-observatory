...
Generated **2026-08-21T15:48:26Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 5.02K tx/s |
| Slot time (sampled) | 0.3681 s |
