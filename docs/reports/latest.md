...
Generated **2026-08-04T23:18:04Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 5.69K tx/s |
| Slot time (sampled) | 0.2461 s |
| Epoch progress | 19.17% |
