...
Generated **2026-08-19T21:05:07Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 5.72K tx/s |
| Slot time (sampled) | 0.4196 s |
| Epoch progress | 30.49% |
...
|---|---|---:|---:|
| WARNING | SOL price | 84.08USD | +9.10% |
