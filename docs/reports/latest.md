...
Generated **2026-09-12T21:39:49Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 3.92K tx/s |
| Slot time (sampled) | 0.3161 s |
| Epoch progress | 64.31% |
| Active validators | 677 |
| Delinquent stake | 0.3889% |

## Economic pulse

| Metric | Current | 24h change |
|---|---:|---:|
| SOL price | 101.56 USD | -1.13% |
| DeFi TVL | 5.89B USD | — |
...
|---|---|---:|---:|
| CRITICAL | Delinquent stake | 0.39% | +1507.02% |
