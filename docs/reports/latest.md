...
Generated **2026-09-18T05:13:11Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 4.55K tx/s |
| Slot time (sampled) | 0.2924 s |
| Epoch progress | 0.33% |
