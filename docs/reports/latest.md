...
Generated **2026-09-22T17:18:09Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 5.09K tx/s |
| Slot time (sampled) | 0.2672 s |
| Epoch progress | 37.92% |
...
|---|---|---:|---:|
| WARNING | SOL price | 117.82USD | +8.07% |
