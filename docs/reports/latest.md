...
Generated **2026-08-12T06:41:30Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 3.09K tx/s |
| Slot time (sampled) | 0.4196 s |
| Epoch progress | 65.33% |
...
|---|---|---:|---:|
| WARNING | Delinquent stake | 0.02% | +111.89% |
