...
Generated **2026-08-18T07:53:30Z** · mainnet-beta · health score **98/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 5.50K tx/s |
| Slot time (sampled) | 0.2135 s |
| Epoch progress | 55.98% |
