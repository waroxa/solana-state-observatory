...
Generated **2026-08-22T11:57:16Z** · mainnet-beta · health score **100/100 (healthy)**
...
|---|---:|
| RPC health | ok |
| Throughput (sampled) | 3.15K tx/s |
| Slot time (sampled) | 0.3679 s |
| Epoch progress | 64.09% |
